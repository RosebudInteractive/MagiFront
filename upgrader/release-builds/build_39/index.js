...
exports.upgradeDb = async (schema) => {
    schema.getModel("Entity")
        ...
        .addField("EffDate", { type: "datetime", allowNull: false })
        .addField("Date", { type: "datetime", allowNull: true })
    ...
    schema.addModel("Period", "35361382-68f6-478f-bd47-6b0d9c1762f9", "RootPeriod", "e358f33f-0968-4606-b5c4-7f83fa47d5b6")
        ...
        .addField("LbEffDate", { type: "datetime", allowNull: true })
        .addField("LbDate", { type: "datetime", allowNull: true })
        ...
        .addField("RbEffDate", { type: "datetime", allowNull: true })
        .addField("RbDate", { type: "datetime", allowNull: true })
