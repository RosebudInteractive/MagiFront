/*
** MSSQL: Upgrade to version ["ProtoOne" v.1.0.0.1 build 3]
*/
alter table [ProductType] add [ExtFields] nvarchar(max) null
GO
...
GO
update [VATType] set [Code] = 'VAT20', [Name] = N'НДС 20%', [ExtFields] = '{"yandexKassaCode":6}' where [Id] = 1
GO
