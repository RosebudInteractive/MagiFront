    ...
    render() {
        ...
        return (
            <div className="lecture-frame__play-block">
                <button type="button" className="lecture-frame__play-control _backwards" onClick={::this._onBackward}>
                ...
                </button>
                {
                    this.props.paused
                        ?
                        <button type="button" className="play-btn-big lecture-frame__play-btn" onClick={::this._startPlay}>
                        ...
                        :
                        <button type="button" className="play-btn-big lecture-frame__play-btn paused"
                                onClick={::this.props.playerStartActions.startPause}>
                            <span className="visually-hidden">Воспроизвести</span>
                            <svg className="pause" width="68" height="92" dangerouslySetInnerHTML={{__html: _pause}}/>
                        </button>
                }
                <button type="button" className="play-btn-big lecture-frame__play-btn paused">
                    <span className="visually-hidden">Воспроизвести</span>
                ...
                <button type="button" className="lecture-frame__play-control _backwards" onClick={::this._onForward}>
                    <span className="label">+10</span>
