    ...
    componentDidMount() {
        ...
        _player.on('touchend', (e) => {
            ...
            let _isContent = e.target.closest('.js-contents'),
                ...
                _isPauseFrame = (e.target.closest('.js-pause-screen') || e.target.closest('.lecture-frame__play-block-wrapper'))
                    && !e.target.closest('.lesson-tooltip')
                    && !e.target.closest('.lecture-frame__play-block')
                    && !e.target.closest('.test-buttons-block')
