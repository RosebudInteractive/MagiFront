...
export const Card = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="card" className="payment-form__text">
            <span className="vp1-universal__body-large">Банковская карта</span>
...
export const Yandex = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="yad" className="payment-form__text">
            <span className="vp1-universal__body-large">Яндекс Деньги</span>
            <div className="payment-method__icons">
                <div className="payment-method__icon">
...
export const Sberbank = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="sber" className="payment-form__text">
            <span className="vp1-universal__body-large">Сбербанк онлайн</span>
            <div className="payment-method__icons">
                <div className="payment-method__icon">
...
export const Alfa = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="alfa" className="payment-form__text">
            <span className="vp1-universal__body-large">Альфа-клик</span>
            <div className="payment-method__icons">
                <div className="payment-method__icon">
...
export const Qiwi = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="qiwi" className="payment-form__text">
            <span className="vp1-universal__body-large">QIWI Кошелек</span>
            <div className="payment-method__icons">
                <div className="payment-method__icon">
...
export const WebMoney = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="webmoney" className="payment-form__text">
            <span className="vp1-universal__body-large">Webmoney</span>
            <div className="payment-method__icons">
                <div className="payment-method__icon">
...
export const Mobile = (props) => {
    return <li className="payment-method">
        ...
        <label htmlFor="mobile" className="payment-form__text">
            <span className="vp1-universal__body-large">Баланс мобильного телефона</span>
        </label>
    </li>
}
...
export const OfferMessage = (props) => {
    return <div className="vp1-universal__body-small subscription-form__offer secondary-dark">
