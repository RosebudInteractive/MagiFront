...
const DEFAULT_DESCRIPTION = "Иллюстрированные онлайн-курсы для всей семьи",
    ...
    DESCRIPTION = {
        ...
        "ny-sale-2021": "Спасибо вам, что слушаете, смотрите, читаете и комментируете лекции наших замечательных авторов! Ваш интерес и поддержка заставляют нас постоянно работать над тем, чтобы создавать новые образовательные курсы, открывать новые разделы, придумывать новые возможности. В первые дни наступающего 2021 года мы хотим сделать платные курсы более доступными и объявляем новогоднюю распродажу! Прикладная психология, отечественная и мировая литература, живопись, история мысли, искусство фотографии – до 10 января мы дарим скидки до 35% на все наши курсы. Если вы уже присмотрели что-то интересное, но ждали подходящего момента, то этот момент настал. Напоминаем также, что курс можно купить в подарок и тоже со скидкой.\n" +
