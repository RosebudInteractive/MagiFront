                        ...
                        <div className="project-info__col">
                            <div className="project-info__text-block">
                                <p className="project-info__text">
                                    ...
                                    <span>тоит услышать живую, осмысленную речь знающего человека, как ум цепляется за
                                        нее, ищет и находит в ней точку опоры для собственной мысли и речи. Один видит в
                                        ней путеводную нить. Другому нужен повод для спора. Но предмет полемики – все то
                                        же изначально прозвучавшее слово.</span>
                                </p>
