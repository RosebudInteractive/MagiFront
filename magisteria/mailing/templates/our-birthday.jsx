...
const IMAGE_URL = window.location.origin + '/data/2019/10/boke-vetki-makro-1571045055360.jpg';
        ...
        <table align="center" style={STYLES.MAIN_TABLE}>
          ...
          <tr>
            <td>
              ...
              <DiscountBlock promo={promo} header={gift.header} description={<div>используйте промокод для любого из платных курсов до 31&nbsp;декабря 2022</div>}/>
              <tr>
