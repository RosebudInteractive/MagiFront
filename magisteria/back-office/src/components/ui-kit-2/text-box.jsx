...
export const UiTextField = ({ extClass, error, value, ...props }) => {
    const className = extClass ? `input-field ${extClass}` : 'input-field';
    const inputValue = value || '';
    return (<StyledTextField {...props} value={inputValue} error={error} variant="outlined" autoComplete="off" className={className}/>);
};
