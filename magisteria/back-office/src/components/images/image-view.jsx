...
const SizeInfo = styled.div `
  ...
  ${typography}
`;
export const ImageView = ({ image, onClose, absolutePath = false }) => {
    ...
    return (<div className={`image-view__dialog ${!loaded ? '_loading' : ''}`}>
      <img ref={ref} style={{ width: width || 'auto', height: height || 'auto' }} src={absolutePath ? image.fileName : `/data/${image.fileName}`} alt={image.description || ''} onLoad={handleImageLoad}/>
