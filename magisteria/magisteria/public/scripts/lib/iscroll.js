...
// INSERT POINT: _refresh
        ...
        scrollToElementVisible: function (el, time, offsetX, offsetY, easing) {
            el = el.nodeType ? el : this.scroller.querySelector(el);
            ...
            // если элемент виден то не скролим top<y && top-height > y-height
            if (pos.top < this.y && pos.top-el.offsetHeight > this.y-this.wrapper.offsetHeight) {
                return;
            }
...
// INSERT POINT: _translate
        ...
        _initEvents: function (remove) {
            ...
            if ( remove || !this.options.disableMouse ) {
        ...
        _initIndicators: function () {
            ...
            if ( this.options.scrollbars ) {
                ...
                if ( this.options.scrollY ) {
                    indicator = {
                        el: createDefaultScrollbar('v', interactive, this.options),
                        interactive: interactive,
                        defaultScrollbars: true,
                        customStyle: customStyle,
                        resize: this.options.resizeIndicator,
                        listenX: false,
                        bottomPadding:this.options.bottomPadding,
                        topPadding:this.options.topPadding,
                        rightPadding:this.options.rightPadding
                    };
                ...
                if ( this.options.scrollX ) {
                    indicator = {
                        el: createDefaultScrollbar('h', interactive, this.options),
                        interactive: interactive,
                        defaultScrollbars: true,
                        customStyle: customStyle,
                        resize: this.options.resizeIndicator,
...
// INSERT POINT: _wheel
        ...
        _initKeys: function (e) {
            ...
            utils.addEvent(this.scroller, 'keydown', this);
            var that = this;
            this.on('destroy', function () {
                utils.removeEvent(that.scroller, 'keydown', this);
            });
        },
    ...
    function createDefaultScrollbar (direction, interactive, options) {
        ...
        if ( type === true ) {
            scrollbar.style.cssText = 'position:absolute;z-index:4;';
        ...
        if ( direction == 'h' ) {
            if ( type === true ) {
                scrollbar.style.cssText += ';left:2px;right:2px;bottom:' + bottomPadding + 'px';
            ...
            if ( type === true ) {
                ...
                scrollbar.style.cssText += ';bottom:'+bottomPadding+'px;top:'+topPadding+'px;right:'+rightPadding+'px';
    ...
    Indicator.prototype = {
        ...
        _move: function (e) {
            ...
            if ( !this.moved ) {
                ...
                utils.addClass(this.indicator.parentNode, 'is-hover');
            }
        ...
        _end: function (e) {
            ...
            if ( this.moved ) {
                ...
                utils.removeClass(this.indicator.parentNode, 'is-hover');
            }
        },
        ...
        refresh: function () {
            ...
            if ( this.scroller.hasHorizontalScroll && this.scroller.hasVerticalScroll ) {
                ...
                if ( this.options.defaultScrollbars && this.options.customStyle ) {
                    if ( this.options.listenX ) {
                        ...
                        this.wrapper.style.bottom = (this.options.bottomPadding? this.options.bottomPadding: 2) +'px';
                    }
                }
            }
            ...
            if ( this.options.listenX ) {
                ...
                if ( this.options.resize ) {
                    this.indicatorWidth = Math.max(Math.round(this.wrapperWidth * this.wrapperWidth / (this.scroller.scrollerWidth || this.wrapperWidth || 1)), 20);
            ...
            if ( this.options.listenY ) {
                this.wrapperHeight = this.wrapper.clientHeight;
                if ( this.options.resize ) {
                    this.indicatorHeight = Math.max(Math.round(this.wrapperHeight * this.wrapperHeight / (this.scroller.scrollerHeight || this.wrapperHeight || 1)), 20);
