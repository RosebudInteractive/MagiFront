...
import LoadingFrame from '#src/components/loading-frame';
import {getDomain, getPageUrl, isMobilePlatform, pages} from "tools/page-tools";

import {refreshState as refreshStorage} from "#src/actions/lesson-info-storage-actions";
import {whoAmI} from "#src/actions/user-actions";
import {setCurrentPage as headerSetPage} from "#src/actions/page-header-actions";
import $ from "jquery";
...
import Header from "#src/components/header-lesson-page";
